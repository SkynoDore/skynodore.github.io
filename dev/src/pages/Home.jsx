      ...
      <section className="p-4 p-md-5 ">
        ...
        <div className="d-flex flex-row flex-wrap justify-content-center gap-5 pt-5">
          <div>
            ...
            <p>
              I had the pleasure of being Gabriel’s direct supervisor during his
              time at BSG, where he stood out as a committed and highly skilled
              professional in web development and design using WordPress and
              FTP, as well as in SEO strategies. From day one, he demonstrated a
              strong ability to adapt and learn quickly, successfully
              implementing various optimization actions that significantly
              improved the visibility and performance of our projects. His
              meticulous approach and his ability to understand each client’s
              needs ensured that everyone was fully satisfied with his work. In
              addition to his technical talent, Gabriel is a responsible,
              hardworking person with a great professional attitude. He was a
              true asset to our team, and I have no doubt that he will bring
              great value to any company that trusts in his talent.
            </p>
          </div>

          <div>
            <h3 className="text-light-emphasis">Álvaro Pascual</h3>
            <h4>Co-founder & CEO en Bluebill</h4>
            <p>
              I directly supervised Gabriel on March 17, 2025. Gabriel is a
              highly competent professional with strong knowledge of WordPress,
              PHP, Laravel, and other programming languages related to web
              design and development. During his time at BSG, he demonstrated
              great ability to develop innovative and efficient solutions, as
              well as an exemplary commitment to established goals and
              deadlines. Gabriel developed functional, visually appealing
              websites tailored to the specific needs of our clients,
              consistently ensuring high standards of quality.
            </p>
          </div>
        </div>
      </section>
